...
namespace Nishar\Feedback\Controller\Adminhtml\View;

use Magento\Backend\App\Action;
use Nishar\Feedback\Helper\Sendmail;
use Nishar\Feedback\Model\FeedbackFactory;
...
class Accept extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Nishar_Feedback::feedback');
    }
